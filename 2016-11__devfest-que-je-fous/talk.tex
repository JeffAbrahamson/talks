...
\begin{frame}
  ...
  \cimg{gtd-history-by-host-class.png}
\end{frame}
...
\begin{frame}
  ...
  \only<1>{\cimg{gtd-recent-days-10.png}}
  \only<2>{\cimg{gtd-recent-days-20.png}}
...
\begin{frame}
  \cimg{plot-similar-3.png}
\end{frame}

\begin{frame}
  \cimg{plot-similar-4.png}
\end{frame}
