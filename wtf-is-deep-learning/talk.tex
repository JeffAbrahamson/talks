...
\begin{frame}
  ...
  \item<2> IBM 704 \gray{(software implementation of algorithm)}
...
\begin{frame}
  \frametitle{Perceptron}
  \begin{itemize}
  \item Minksy and Papert showed perceptrons incapable of recognizing
    certain classes of images
  \item AI community mistakenly over-generalized to all NN's
  \item So NN research stagnated for some time
  \end{itemize}
