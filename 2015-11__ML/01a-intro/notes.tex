...
\item It's important to see examples.  So we'll spend time in code for that reason, too.
\item We have to learn scikit-learn, even if it's not what you use later.
\end{itemize}
...
\item Distributions
  ...
  \end{itemize}
\item \fbox{Normal distributions ($\times 2$)} --- TODO: compare in matplotlib, quantile-quantile plot
  \begin{itemize}
