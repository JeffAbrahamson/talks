...
\newcommand\cimgh[1]{\vfill\centerline{\includegraphics[height=.9\textwidth]{#1}}\vfill}
\newcommand\cimghh[1]{\vfill\centerline{\includegraphics[height=.8\textwidth]{#1}}\vfill}
