...
\begin{frame}
  ...
  \only<2-4> {
    \centerline{\includegraphics[width=.8\textwidth]{teeter-totter.png}}
  }
  \only<3>{
    \begin{displaymath}
  ...
  \only<6>{
    \centerline{\includegraphics[width=.8\textwidth]{centroid-hanging-discrete.png}}
  }
  \only<7>{
    \centerline{\includegraphics[width=.8\textwidth]{centroid-balance-continuous.png}}
  }
\end{frame}
