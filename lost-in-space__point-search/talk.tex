...
\begin{frame}
  ...
  \item Bentley, 1975
    \textcolor{gray}{\small\it(J.~L.~Bentley, Multidimensional binary
      search trees used fo rassociative searching, Communications of
...
\begin{frame}
  ...
  \begin{itemize}
  \item Bentley, 1979
    \textcolor{gray}{\small\it J.~L.~Bentley, Decomposable
